...
from cfuse.llm.providers.openai_compatible import OpenAICompatibleLLM
...
def create_llm(
    ...
    **kwargs
    ...
    if provider == "anthropic":
        from cfuse.llm.providers.anthropic import AnthropicLLM
        return AnthropicLLM(
            model=model,
            api_key=api_key,
            base_url=base_url,
        ...
        from cfuse.llm.providers.gemini import GeminiLLM
        return GeminiLLM(
            model=model,
            api_key=api_key,
            base_url=base_url,
